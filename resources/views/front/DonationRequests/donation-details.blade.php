...
@section('class-name','inside-request')
@section('content')
            ...
            <div class="path">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">طلب التبرع: {{
                            $donationRequest->patient_name }}</li>
                    </ol>
                </nav>
            </div>
            <div class="details">
                ...
                <div class="location">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3418.0770797767814!2d31.409187284906096!3d31.051953681527007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f79db9d4d56311%3A0x69ad97566dc9bd76!2z2YXYs9iq2LTZgdmJINin2YTYrtmK2LE!5e0!3m2!1sar!2seg!4v1597910005047!5m2!1sar!2seg&z=15&q={{ $donationRequest->latitude }},{{ $donationRequest->longitude }}"
